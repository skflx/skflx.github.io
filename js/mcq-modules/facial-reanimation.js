...
const ITEMS = [
...

  {
    ...
    options: [
      { id: 'a', text: 'NTM: superior resting tone; Hypoglossal: strong dynamic smile excursion' },
...

  {
    ...
    options: [
      ...
      { id: 'b', text: 'Masseteric nerve (NTM) to distal facial nerve — reliable, high axonal load, strong commissure excursion' },
